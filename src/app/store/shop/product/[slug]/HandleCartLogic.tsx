...
import {
  ContainerSimple,
  Grid,
} from "@/components/_ui/containers/container-simple";
...
export default function HandleCartLogicComponent({
  ...
  const [selection, setSelection] = useState({
    ...
    variants:product.variants?.reduce((acc, v) => {
          ...
          return {...acc,[v.label]: {value: firstOption.value,priceModifier: firstOption.priceModifier || 0,},};},
          {} as Record<string, { value: string; priceModifier: number }>,) || {},
  });
  ...
  const basePrice = product.price_rupees;
  ...
  return (
    <ContainerSimple className="gap-3">
      ...
      <AddToCartButton
        product={{
          ...product,
          price_rupees: finalUnitPrice, // The calculated total
          base_price_rupees: basePrice, // The original price
        }}
