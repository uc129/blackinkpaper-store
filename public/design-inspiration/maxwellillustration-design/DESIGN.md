...
@font-face {
  ...
  src: url("https://fonts.gstatic.com/s/youngserif/v2/3qTpojO2nS2VtkB3KtkQZ2t6.ttf") format("truetype");
  font-weight: 400;
}
@font-face {
  font-family: "squarespace-ui-font";
  src: url("https://assets.squarespace.com/universal/fonts/squarespace-ui-font.eot") format("embedded-opentype");
  font-weight: 400;
}
@font-face {
  font-family: "social-icon-font";
  src: url("https://assets.squarespace.com/universal/fonts/social-20141119/social-icon-font.eot") format("embedded-opentype");
  font-weight: 400;
}
```
